...
public class DListNode extends ListNode {
    ...
    public void insertAfter(Object item) throws InvalidNodeException {
        ...
        //   new node.
        DListNode newDNode = ((DList) myList).newNode(item, (DList)myList, this, next);
        next.prev = newDNode;
        next = newDNode;
    }
    ...
    public void insertBefore(Object item) throws InvalidNodeException {
        ...
        //   what DList it's in.  You should use myList.newNode() to create the
        //   new node.
        DListNode newDNode = ((DList) myList).newNode(item, (DList)myList, prev, this);
        prev.next = newDNode;
        prev = newDNode;
    }
    ...
    public void remove() throws InvalidNodeException {
        ...
        //   "this" is null.  Remember that this node's "myList" field tells you
        //   what DList it's in.
        System.out.println("before " + prev.item + " " + next.item + " " + prev.next.item + " " + next.prev.item);
        prev.next = next;
        next.prev = prev;
        System.out.println("after " + prev.item + " " + next.item + " " + prev.next.item + " " + next.prev.item);
